...
const Excellent = () => {
  return (
    <section className="flex flex-col justify-center items-center space-y-4 h-auto py-15 mt-[-5rem] md:py-20 lg:h-screen bg-gray-100 p-2 md:p-4 lg:p-6">
      <h1 className="text-2xl pl-4 font-bold md:text-3xl lg:text-6xl font-sans">
        Driving excellent and Innovation in car
      </h1>
      <h2 className="text-2xl pr-15 font-bold md:text-3xl lg:text-6xl font-sans">
        <span className="text-yellow-500">Buying </span> &{" "}
        <span className="text-yellow-500">rental </span>services
      </h2>
      <p className="text-md md:text-xl lg:text-xl lg:w-[70rem] p-4">
      ...
      <div className="bg-gray-200 w-[23rem] md:w-[35rem] p-2.5 sm:p-2 flex space-x-4 md:space-x-6 justify-between items-center rounded-r-full rounded-l-full mt-15">
        <Button
          label="Our Value"
